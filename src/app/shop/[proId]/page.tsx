    ...
    <>
      ...
      <div className="container mx-auto px-4">
        ...
        <section className="flex flex-col md:flex-row gap-[16px] my-[80px]">
          ...
          <div className="w-[500px] h-[600px] relative  rounded-[4px] flex justify-center items-center">
            {image && (
          ...
          <div className="xl:w-[500px] xxs:w-[200px] h-[600px] xl:ml-[60px] xxs:ml-[0px]">
            ...
            <div className="text-[16px] mr-[8px] xl:mt-[20px] xxs:mt-[40px] text-black">Colours:</div>
          ...
          flex justify-center items-center ">
            ...
            <div className="mt-[40px] h-[90px] w-[400px] rounded-t-[4px] flex gap-[16px] items-center leading-6">
             ...
             {/* Share */}
     <div className="w-[250]  ml-[780px] gap-[35px] pt-[15px]  flex">
...
<ProductReviews />
        ...
        {/* <div className="font-semibold text-center mt-[180px] text-[18px]"> 
            ...
            &nbsp; &nbsp;  <span className="text-[#838282]"></span> 
          </div>

          <div className="text-[16px] text-[#6e6e6e] mt-[25px]">
       {dynamicDescription}
          </div>
        ...
        <div className='text-[36px] font-semibold text-center pt-[10px] mt-[850px]'>Related Products</div>
  ...
  {res.slice(0, 4).map((item: ProductCard, index: number) => (
    <div key={index} className="flex flex-col items-center">
      ...
      <div className="text-[24px] font-semibold mt-2 text-center">
        <Link
          href={`/shop/proId?heading=${item.cardHeading}&image=${item.cardImg}&price=${item.cardPrice}`}
        >
          Rs. {item.cardPrice}.00
        </Link>
      </div>
    </div>
  ))}
</div> */}
 <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-[100px]">
    ...
    return (
      ...
      >
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black via-transparent to-transparent flex flex-col justify-end text-white px-4 pb-6 group-hover:opacity-100 transition-opacity duration-300 z-10">
          ...
          <div className="text-[20px] font-bold mt-1">Rs. {item.price}.00</div>
